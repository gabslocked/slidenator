/**
 * icons.js — GERADO por scripts/build-icons.mjs. Não editar à mão.
 * Fonte: lucide-static v1.26.0 (ISC). Paths inline, viewBox 24, stroke currentColor.
 * 310 ícones em 11 categorias.
 */
export const ICONS = {
...
export const ICON_CATEGORIES = {
  "negocios": ["briefcase","building","building-2","target","trophy","award","medal","handshake","presentation","rocket","lightbulb","flag","megaphone","gem","crown","star","sparkles","goal","badge-check","store","shopping-cart","shopping-bag","tag","tags","ticket","gift"],
  "dados": ["chart-line","chart-bar","chart-column","chart-pie","chart-area","chart-scatter","chart-no-axes-column","chart-candlestick","chart-spline","activity","trending-up","trending-down","gauge","database","table","table-2","sigma","percent","hash","filter","funnel","layers","grid-2x2","list","list-checks","list-ordered","binary","scan"],
  "tecnologia": ["server","cpu","hard-drive","memory-stick","container","boxes","box","cloud","cloud-cog","cloudy","code","code-xml","terminal","terminal-square","git-branch","git-commit-horizontal","git-merge","git-pull-request","network","wifi","bluetooth","plug","plug-zap","power","settings","settings-2","cog","wrench","bug","shield","shield-check","lock","unlock","key","fingerprint","monitor","smartphone","laptop","tablet","mouse-pointer-2","keyboard","webhook","braces","file-code"],
  "pessoas": ["user","users","user-plus","user-minus","user-check","user-x","user-cog","user-round","users-round","contact","id-card","badge","graduation-cap","briefcase-business","building-2","heart-handshake","baby","accessibility","person-standing","smile","frown","meh"],
  "financas": ["dollar-sign","euro","pound-sterling","banknote","coins","credit-card","wallet","piggy-bank","landmark","receipt","calculator","scale","trending-up","trending-down","circle-dollar-sign","hand-coins","chart-no-axes-combined","arrow-up-right","arrow-down-right","bitcoin"],
  "tempo": ["clock","clock-3","clock-9","timer","timer-reset","alarm-clock","hourglass","calendar","calendar-days","calendar-check","calendar-clock","calendar-range","history","rotate-ccw","rotate-cw","watch","sunrise","sunset"],
  "comunicacao": ["mail","mail-open","send","message-circle","message-square","messages-square","phone","phone-call","video","mic","mic-off","bell","bell-ring","bell-off","share-2","link","link-2","at-sign","rss","radio","speech","quote","inbox","reply","forward"],
  "logistica": ["truck","package","package-check","package-open","boxes","warehouse","forklift","ship","plane","train-front","car","bike","map","map-pin","map-pinned","navigation","compass","route","milestone","globe","globe-2","anchor","fuel","container"],
  "saude": ["heart","heart-pulse","activity","stethoscope","pill","syringe","thermometer","cross","hospital","ambulance","bandage","brain","dna","microscope","test-tube","test-tube-diagonal","leaf","shield-plus"],
  "educacao": ["graduation-cap","book","book-open","book-open-check","library","notebook","notebook-pen","pencil","pen-tool","highlighter","ruler","calculator","flask-conical","atom","lightbulb","brain-circuit","school","backpack","clipboard-list","clipboard-check"],
  "ui": ["arrow-up","arrow-down","arrow-left","arrow-right","arrow-up-right","arrow-down-right","arrow-right-left","move-right","chevron-right","chevron-down","chevrons-right","corner-down-right","check","check-check","x","plus","minus","circle-check","circle-x","circle-alert","circle-help","circle-plus","triangle-alert","info","ban","zap","flame","search","eye","eye-off","download","upload","refresh-cw","refresh-ccw","play","pause","square","circle","circle-dot","dot","more-horizontal","menu","grip","maximize","minimize","expand","thumbs-up","thumbs-down","bookmark","pin","trash-2","edit","copy","clipboard","save","folder","folder-open","file","file-text","file-check","paperclip","sliders-horizontal","layout-dashboard","layout-grid","workflow","archive","command","external-link","log-in","log-out","toggle-left","toggle-right","circle-user","square-check-big","loader","loader-circle"],
};
